...
declare namespace CesiumMap {
    ...
    interface Event {
        OnElementsSelected: (datas: Array<CesiumDataController.Element> | null) => void
        ...
        OnPointDragend: () => void;
        OnMouseClick: (position: CesiumDataController.Position, zoom: number) => void;
        OnMouseDoubleClick: (position: CesiumDataController.Position, zoom: number) => void;
    }
    interface ExtendedWindow {
        Register: (element: HTMLElement, boxId: string, css_urls: Array<string>, events: any) => void;
    ...
    interface AlarmPoint {
        ...
        Add: (position: CesiumDataController.Position, color: string, isInWindow: boolean) => string;
    ...
    interface Element {
        ...
        SetPosition: (elementId: string, position: CesiumDataController.Position) => void;
    ...
    //#region Draw
    interface DrawLine {
        Drawing: (begin: CesiumDataController.Position, end: CesiumDataController.Position, opts: CesiumDataController.DrawLineOptions, over: boolean) => CesiumDataController.Polyline;
        Redraw: (id: string, begin: CesiumDataController.Position, end: CesiumDataController.Position, opts: CesiumDataController.DrawLineOptions, over: boolean) => CesiumDataController.Polyline;
        Remove: (id: string) => boolean;
    }
    interface DrawEllipsoid {
        Drawing: (begin: CesiumDataController.Position, end: CesiumDataController.Position, opts: CesiumDataController.DrawEllipsoidOptions, over: boolean) => CesiumDataController.Ellipsoid;
        Redraw: (id: string, begin: CesiumDataController.Position, end: CesiumDataController.Position, opts: CesiumDataController.DrawEllipsoidOptions, over: boolean) => CesiumDataController.Ellipsoid;
        Remove: (id: string) => boolean;
    }
    interface DrawPolyline {
        Drawing: (positions: Array<CesiumDataController.Position>, opts: CesiumDataController.DrawLineOptions, over: boolean) => CesiumDataController.Polyline;
        Redraw: (id: string, positions: Array<CesiumDataController.Position>, opts: CesiumDataController.DrawLineOptions, over: boolean) => CesiumDataController.Polyline;
        Remove: (id: string) => boolean;
    }
    interface DrawPolygon {
        Drawing: (positions: Array<CesiumDataController.Position>, opts: CesiumDataController.DrawPlaneOptions, over: boolean) => CesiumDataController.Polygon;
        Redraw: (id: string, positions: Array<CesiumDataController.Position>, opts: CesiumDataController.DrawPlaneOptions, over: boolean) => CesiumDataController.Polygon;
        Remove: (id: string) => boolean;
    }
    interface DrawHeatmap {
        Draw: (datas: Array<CesiumDataController.HeatmapData>, max?: number) => string;
