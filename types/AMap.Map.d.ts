declare namespace AMap {
    ...
    class Map extends EventHandle<"complete" | "click" | "dblclick" | "mapmove" | "hotspotclick" | "hotspotover" | "hotspotout" | "movestart" | "moveend" | "zoomchange" | "zoomstart" | "zoomend" | "mousemove" | "mousewheel" | "mouseover" | "mouseout" | "mouseup" | "mousedown" | "rightclick" | "dragstart" | "dragging" | "dragend" | "resize" | "touchstart" | "touchmove" | "touchend"> {
        ...
        getCity(callback: (province: string, city: string, citycode: string, district: string) => void): void;
        ...
        setZoomAndCenter(zoomLevel: number, center: LngLatNum): void;
        ...
        // 在 3D 模式下，将经纬度坐标转换为三维坐标系下的 xy 坐标
        lngLatToGeodeticCoord(lnglat: LngLat): Pixel;

        //  在 3D 模式下，将三维坐标系下的 xy 坐标转换为经纬度坐标
